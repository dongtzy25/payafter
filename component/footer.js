            ...
            <Modal showModal={showModal} setShowModal={setShowModal}/>
                <div className="container mx-auto py-12 lg:px-20 px-4 ">
                    <div className="lg:flex flex-row items-start justify-start lg:space-x-12 lg:text-left text-center">
                        <div className="mr-4 xl:w-1/3 lg:w-1/2 w-full">
                        <Link href="/"> 
                        <a> <Image
                                src={Logo}
                                alt="Logo"
                ...
                <div className="container mx-auto py-8 lg:px-20 px-4 border-t-2">
                    <div className="flex lg:flex-row flex-col items-center justify-between">
                        <div className="lg:pr-12 lg:text-left text-center">
                            <span className="xl:inline-block block ">Copyright © 2021</span> PayAfter by Cebuana Lhuillier Finance Corp. (CLFC) <span className="xl:inline-block block ">an SEC Licensed Financing Company</span></div>
