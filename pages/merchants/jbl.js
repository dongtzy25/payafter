...
const JBLPage = () => {
  ...
  return (
    <Layout>
      <div className="w-full xl:py-12 lg:py-8 pt-8 relative overflow-hidden custom-banner jbl-color">
        <animated.div
          style={animation}
          className="custom-imageSize absolute xl:top-16 lg:top-16 top-52 -right-2 lg:flex md:flex sm:flex hidden"
        >
          <Image src={JBL} alt="Logo" unoptimized={true} />
        </animated.div>
        <div className="container mx-auto mb-8 lg:pl-24 pl-12">
          ...
          <Link href="/merchants/jbl">
            <a className="cursor-pointer">JBL</a>
          </Link>
        </div>
        <div className="container mx-auto flex lg:flex-row flex-col items-center justify-between ">
          <div className="xl:w-6/12 lg:w-7/12 w-full text-left lg:pl-24 pl-12 z-10 relative">
            ...
            >
              <p className="mt-4">
                Discover the freedom with JBL. Get yours now with PayAfter!
              </p>
              <div className="relative block w-full border-solid">
                ...
                <div className="relative pl-12 mt-8 ">
                  ...
                  <p className="mb-4 pt-1">
                    Place your order via Tech Bytes, an authorized distributor of JBL, by clicking this&nbsp; 
                    <Link href="https://form.jotform.com/212311127195446">
        ...
        <div className="container mx-auto  text-center">
          <div className="w-4/5 mx-auto">
            ...
            <p className="text-lg mt-4 lg:w-4/6 lg:mx-auto">
              JBL has brought music to life in a way people can feel for over 70
              years. From iconic concerts to the world’s biggest sporting
              events, our award-winning sound has powered the world’s most epic
              musicians, athletes and venues. We unleash the power of music so
              you can live life to the fullest wherever and whenever.
            </p>
            <div className="grid xl:grid-cols-3 lg:grid-cols-3 grid-cols-1 gap-4 mt-10">
              <div
                className="shadow-lg flex bg-white relative justify-self-end max-w-xs items-center justify-center rounded-lg lg:mx-0 mx-auto lg:mb-0 mb-4 transform transition duration-500 hover:scale-105
                            "
              >
                <Image src={JBL1} alt="Logo" unoptimized={true} />
              </div>
              <div className="shadow-lg flex items-center relative justify-self-center max-w-xs justify-center rounded-lg lg:mx-0 mx-auto lg:mb-0 mb-4  transform transition duration-500 hover:scale-105">
                <Image src={JBL2} alt="Logo" unoptimized={true} />
              </div>
              <div className="shadow-lg flex bg-white relative justify-self-start max-w-xs items-center justify-center rounded-lg lg:mx-0 mx-auto lg:mb-0 mb-4  transform transition duration-500 hover:scale-105">
                <Image src={JBL3} alt="Logo" unoptimized={true} />
              </div>
            </div>
            <button
              onClick={() => {
                window
                  .open("https://form.jotform.com/212311127195446")
                  .focus();
              }}
              className="
                                inline-block 
