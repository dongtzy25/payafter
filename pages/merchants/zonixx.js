            ...
            <div className="w-full pt-8 relative overflow-hidden custom-banner jbl-color">
                ...
                <div className="container mx-auto flex lg:flex-row flex-col items-center justify-between ">
                    <div className="xl:w-6/12 lg:w-7/12 w-full text-left lg:pl-24 pl-12 z-10 relative">
                        <h1 className="lg:text-5xl text-4xl font-bold xl:text-left lg:text-left text-center pr-4">Ride your bike</h1>  
                        <h1 className="lg:text-5xl text-4xl font-bold mt-4 xl:text-left lg:text-left text-center pr-4"> with Zonixx</h1>
                        <div className="py-8 
                        ...
                        <div className="xl:bg-transparent lg:bg-transparent bg-white py-8 pr-8 relative md-custom-bg" style={{zIndex:'1'}}>
                            ...
                            <div className="relative block w-full border-solid">
                                ...
                                <div className="relative pl-12 mt-8 ">
                                    ...
                                    <p className="mb-4 pt-1">Visit Zonixx&apos;s authorized distributor&apos;s Facebook page. You can also check out their products <Link href="https://www.facebook.com/TechBytesITSolutions/"><a target="_blank" className="text-blue-500 underline"> here</a></Link>.</p>
                                </div>
                                <div className="relative pl-12 mt-8 ">
                                ...
                                <div className="relative pl-12 mt-8 ">
                                    ...
                                    <p className="mb-4 pt-1">Once your order has been confirmed, Zonixx will send to you the PayAfter link.</p>
                                </div>
                                <div className="relative pl-12 mt-8 ">
