      ...
      <div className="w-full xl:py-12 lg:py-8 pt-8 relative overflow-hidden custom-banner aiwa-color">
        ...
        <div className="container mx-auto mb-8 lg:pl-24 pl-12">
          ...
          <Link href="/merchants/aiwa">
            <a className="cursor-pointer">Aiwa</a>
          </Link>
        </div>
        <div className="container mx-auto flex lg:flex-row flex-col items-center justify-between">
          <div className="xl:w-6/12 lg:w-7/12 w-full text-left lg:pl-24 pl-12 z-10 relative">
            ...
            >
              <p className="mt-4">
                Avail Aiwa products now for greater convenience and quality of
                life with PayAfter.
              </p>
              <div className="relative block w-full border-solid ">
                ...
                <div className="relative pl-12 mt-8 ">
                  ...
                  <p className="mb-4 pt-1">
                    Place your order via JM Appliances and Gadgets, an authorized distributor of Aiwa, by clicking this&nbsp;
                    <Link href="https://form.jotform.com/212332621511440">
                ...
                {/* <div className="relative pl-12 mt-8 ">
                  ...
                  <p className="mb-4 pt-1">
                    Once your order has been confirmed, Aiwa Philippines will
        ...
        <div className="container mx-auto  text-center">
          <div className="w-4/5 mx-auto">
            ...
            <p className="text-lg mt-4 lg:w-4/6 lg:mx-auto">
              The passionate pursuit of bringing people together around
              entertainment. We have a simple formula for delivering good
              quality - our passion for quality rooted in our Japanese heritage,
              our money into the highest quality components, and our world class
              customer service.
            </p>
            <div className="grid xl:grid-cols-3 lg:grid-cols-3 grid-cols-1 gap-4 mt-10 place-center">
              <div
                className="shadow-lg flex bg-white relative justify-self-end max-w-xs  justify-center rounded-lg lg:mx-0 mx-auto lg:mb-0 mb-4  transform transition duration-500 hover:scale-105
                            "
              >
                <Image src={Aiwa1} alt="Logo" />
              </div>
              ...
              <div className=" justify-self-start max-w-xs relative shadow-lg flex bg-white items-center justify-center rounded-lg lg:mx-0 mx-auto lg:mb-0 mb-4  transform transition duration-500 hover:scale-105">
                <Image src={Aiwa3} alt="Logo" />
              </div>
            </div>
            <button
              onClick={() => {
                window
                  .open("https://form.jotform.com/212332621511440")
                  .focus();
              }}
              className="
                                inline-block 
