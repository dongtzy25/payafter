      ...
      <div className="w-full xl:py-12 lg:py-8 pt-8 relative overflow-hidden custom-banner haier-color">
        ...
        <div className="container mx-auto mb-8 lg:pl-24 pl-12">
          ...
          <Link href="/merchants/haier">
            <a className="cursor-pointer">Haier</a>
          </Link>
        </div>
        <div className="container mx-auto flex lg:flex-row flex-col items-center justify-between ">
          <div className="xl:w-6/12 lg:w-7/12 w-full text-left lg:pl-24 pl-12 z-10 relative">
            ...
            >
              <p className="mt-4">
                Buy your own Haier with PayAfter with these five easy steps:
              </p>
              <div className="relative block w-full border-solid">
                ...
                <div className="relative pl-12 mt-8 ">
                  ...
                  <p className="mb-4 pt-1">
                    Place your order via JM Appliances and Gadgets, an authorized dealer of Haier, by clicking this&nbsp;
                    <Link href="https://form.jotform.com/DaryllMutya/haier---via-jm-appliances-and-gadge">
                ...
                {/* <div className="relative pl-12 mt-8 ">
                  ...
                  <p className="mb-4 pt-1">
                    Once your order has been confirmed, Haier Philippines will
        ...
        <div className="container mx-auto  text-center">
          <div className="w-4/5 mx-auto">
            ...
            <p className="text-lg mt-4 lg:w-4/6 lg:mx-auto">
              Today Haier has spread all over Asia, Africa, Europe, North
              America and the Middle East, and all corners of the world. There
              are 10 R&D centers, 24 industrial parks, 66 marketing centers and
              108 manufacturing plants in the world. New brands continue to join
              the Haier family, Aqua, Fischer Parker, GEA, Candy, have become a
              member of Haier. Haier, is crossing the culture, merging the
              brand, and coming to you quickly!
            </p>
            <div className="grid xl:grid-cols-3 lg:grid-cols-3 grid-cols-1 gap-4 mt-10">
              ...
              <div className="shadow-lg flex bg-white relative  justify-self-start max-w-xs items-center justify-center rounded-lg lg:mx-0 mx-auto lg:mb-0 mb-4 transform transition duration-500 hover:scale-105">
                <Image src={Haier3} alt="Logo" />
              </div>
            </div>
            <button
              onClick={() => {
                window
                  .open("https://form.jotform.com/DaryllMutya/haier---via-jm-appliances-and-gadge")
                  .focus();
              }}
              className="
                                inline-block 
