...
import Asus from "../../public/assets/images/asus/asus.png";
import Asus1 from "../../public/assets/images/asus/asus-01.jpeg";
import Asus2 from "../../public/assets/images/asus/asus-02.jpg";
import Asus3 from "../../public/assets/images/asus/asus-03.jpg";
...
const AsusPage = () => {
  ...
  return (
    <Layout>
      <div className="w-full xl:py-12 lg:py-8 pt-8 relative overflow-hidden custom-banner asus-color ">
        <animated.div
          style={animation}
        ...
        >
          <Image src={Asus} alt="Logo" unoptimized={true} />
        </animated.div>
        <div className="container mx-auto mb-8 lg:pl-24 pl-12">
          ...
          <span className="px-4">/</span>
          <Link href="/merchants/asus">
            <a className="cursor-pointer">Asus</a>
          </Link>
        </div>
        <div className="container mx-auto flex lg:flex-row flex-col items-center justify-between ">
          <div className="xl:w-6/12 lg:w-7/12 w-full text-left lg:pl-24 pl-12 z-10 relative">
            ...
            >
              <p className="mt-4">
                Purchase any of Asus products using PayAfter
              </p>
