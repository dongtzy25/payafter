            ...
            <div className="w-full pt-8 relative overflow-hidden custom-banner itel-color">
                ...
                <div className="container mx-auto flex lg:flex-row flex-col items-center justify-between ">
                    <div className="xl:w-6/12 lg:w-7/12 w-full text-left lg:pl-24 pl-12 z-10 relative">
                        <h1 className="lg:text-5xl text-4xl font-bold xl:text-left lg:text-left text-center pr-4">Explore a bigger world</h1> 
                        <h1 className="lg:text-5xl text-4xl font-bold mt-4 xl:text-left lg:text-left  text-center pr-4">through your vision</h1>
                        <div className="py-8 
                ...
                <div className="container mx-auto  text-center">
                    <div className="w-4/5 mx-auto">
                        ...
                        <div className="grid xl:grid-cols-3 lg:grid-cols-3 grid-cols-1 gap-4 mt-10">
                            <div className="shadow-lg flex bg-white relative items-center justify-self-end max-w-xs justify-center rounded-lg lg:mx-0 mx-auto lg:mb-0 mb-4 transform transition duration-500 hover:scale-105
                            ">
                                    <Image
                                        src={Itel1}
                                        alt="Logo"
